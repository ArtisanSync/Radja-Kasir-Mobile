    ...
    try {
      ...
      if (result['success'] == true) {
        ...
        if (result['subscriptionRequired'] == true) {
          _showSubscriptionRequiredDialog(result['message'] ?? 'Anda memerlukan langganan untuk membuat toko');
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: _storeTypes.map<DropdownMenuItem<String>>((Map<String, String> type) {
              ...
              ModernButton(
                text: widget.isFirstStore ? 'Buat Toko Pertama' : 'Simpan Toko Baru',
