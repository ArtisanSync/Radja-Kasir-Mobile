...
class FormUploadStamp extends StatefulWidget {
  const FormUploadStamp({Key? key}) : super(key: key);

  @override
  State<FormUploadStamp> createState() => _FormUploadStampState();
}

class _FormUploadStampState extends State<FormUploadStamp> {
  ...
  Future<void> submit() async {
    ...
    var resp = await profileServices.uploadStamp(body);
